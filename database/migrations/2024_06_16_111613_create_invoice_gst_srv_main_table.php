...
return new class extends Migration
{
    ...
    {
        Schema::create('invoice_gst_srv_main', function (Blueprint $table) {
            $table->integer('id')->primary();
            $table->string('invoice_no', 30)->nullable();
            $table->string('refjob', 20)->nullable()->index('refjob');
            ...
            $table->float('ssgst_amount')->nullable();
    ...
    {
        Schema::dropIfExists('invoice_gst_srv_main');
    }
};
